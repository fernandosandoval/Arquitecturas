...
public class OtrosServicios {
	...
	public static List<Revision> buscarTodosLasRevisionesPorRevisorYFecha(int idUsuario, Date fechaInicio, Date fechaFin, EntityManager emanager){
        String jpql = "select r from Revisiones r where r.fecha >= " +fechaInicio+" and r.fecha <="+fechaFin+"";   
        
        Query query = emanager.createNativeQuery(jpql);  
